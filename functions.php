<?php
/**
 * UCalgary Theme functions and definitions
 *
...
if ( ! function_exists( 'ucalgary_setup' ) ) :
	/**
	 ...
	 */
	function ucalgary_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on UCalgary Theme, use a find and replace
		 * to change 'ucalgary' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'ucalgary', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'ucalgary' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'ucalgary_custom_background_args', array(
...
add_action( 'after_setup_theme', 'ucalgary_setup' );
 ...
 */
function ucalgary_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'ucalgary_content_width', 640 );
}
add_action( 'after_setup_theme', 'ucalgary_content_width', 0 );
 ...
 */
function ucalgary_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'ucalgary' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'ucalgary_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function ucalgary_scripts() {
	wp_enqueue_style( 'ucalgary-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'ucalgary_scripts' );
